...
@inject('authStore')
@observer
export default class ImportPrivatePage extends Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  @bindMethod onRestorePress() {
    ...
    this.props.authStore.accountImportPrivateKey(this.state.password)
      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <Input
            ...
            onTextInput={value => this.setState({ privateKey: value })}
          />
